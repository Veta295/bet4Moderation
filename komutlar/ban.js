...
message.channel.send(new MessageEmbed().setImage('https://cdn.discordapp.com/attachments/825721841053728821/825730298267566170/ban.gif').setDescription(`${message.author} tarafından ${kullanici} \`${sebep}\` Sebebiyle Sunucudan Yasaklandı.`).setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setColor('0x348f36')) 
